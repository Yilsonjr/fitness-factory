...
// Strip surrounding quotes if the value was accidentally stored with them
const clean = (v) => v.replace(/^['"]|['"]$/g, '').trim();

const content = `// Auto-generated by scripts/set-env.js — do not edit manually.
export const environment = {
  production: true,
  supabaseUrl: ${JSON.stringify(clean(supabaseUrl))},
  supabaseKey: ${JSON.stringify(clean(supabaseKey))},
};
`;
